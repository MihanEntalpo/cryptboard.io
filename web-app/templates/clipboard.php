<h1>{Clipboard}</h1>
<div class="copy-button" id="single-copy-button"><button class="btn btn-success btn-sm" title="{Copy to clipboard}" ><i class="fa fa-clipboard"></i> Ctrl+C</button></div>
    ...
    <div class="col-8 messages-wrapper">
      ...
      <div class='send'>
          ...
          <div class="horizontal-buttons">
              ...
              <span class='grey-info'>{Drag&drop file to the button→}</span>
